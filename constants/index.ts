...
export const PRODUCTS = [
  {
    ...
    title: "BuyNow",
    description:
      "The ultimate marketplace for secure digital purchases and reliable transactions.",
  ...
  },
  {
    ...
    title: "SellNow",
    description:
      "Empowering local businesses with a seamless selling platform. Streamlining trade in Nepal.",
    link: "#", // Dummy for now
